...
def load_orchestration_prompt(original_message: str, name: str, is_new_user: bool = False):
    project_root = os.path.dirname(os.path.dirname(__file__))
    config_path = os.path.join(project_root, "config", "orchestration_prompt.txt")
...
def load_communication_prompt(name: str, is_new_user: bool = False):
    project_root = os.path.dirname(os.path.dirname(__file__))
